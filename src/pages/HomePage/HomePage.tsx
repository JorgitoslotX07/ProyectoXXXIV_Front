...
export const HomePage: FC<HomePageProps> = ({
  ...
  return (
    <>
     <div className="bg-[#cff7ee] text-[#1f2937] [background-image:radial-gradient(at_47%_33%,hsl(68.52,81%,60%)_0,transparent_59%),radial-gradient(at_82%_65%,hsl(42.97,100%,85%)_0,transparent_55%)] backdrop-blur-[10px] backdrop-saturate-[100%] min-h-screen font-sans transition-colors duration-300">

        
        {/* 🔍 Sección de búsqueda inicial */}
        <div className="relative">
          <div className="absolute inset-0 bg-[url('fondoFastSeartch.webp')] bg-cover bg-center"></div>
    ...
    <div className="pt-20 px-10 bg-[#f3fce9]">
        ...
        <div className="relative">
          <div className="mt-20 px-10 pb-20">
            <h2 className="text-2xl font-semibold mb-6 pl-3 text-yellow-500">
              {t("home.newsTitle")}
            </h2>
            <NoticiasComponent />
          </div>
        ...
        <Link to="/map">
          <div className="w-full h-40 relative group cursor-pointer overflow-hidden border border-gray-300 rounded-md shadow-md hover:shadow-lg transition-shadow duration-300">
            <img
              src="/MapClick.png"
            ...
            />
            <div className="absolute inset-0 flex items-center justify-center bg-white/60 opacity-40 group-hover:opacity-60 dark:bg-black/60 dark:opacity-60 transition-opacity duration-500">
              <span className="text-yellow-500 text-lg font-semibold px-4 py-2 transition-colors duration-300">
                {t("home.mapButton")}
              </span>
            </div>
          </div>
