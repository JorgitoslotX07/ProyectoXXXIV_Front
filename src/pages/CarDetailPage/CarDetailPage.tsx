                    ...
                    {product.reviews.map((rev, idx) => (
                        <div key={idx} className="mb-2">
                            ...
                            {[...Array(5)].map((_, i) => (
                                ...
                                key={i}
                                className={`w-4 h-4 ${
                                    i < rev.valoracion ? "fill-black text-black" : "fill-gray-300 text-gray-300"
                                }`}
                                />
                            ))}
                            <span className="ml-2 text-sm text-gray-600">({rev.valoracion}/5)</span>
                            </div>
                            <p className="text-sm text-gray-800 italic">"{rev.comentario}"</p>
                        </div>
                        ))}
